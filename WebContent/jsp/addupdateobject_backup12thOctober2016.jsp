...
<body onload="$('input:text:visible:first').focus()" ng-init="appCtrl.setCurrentForm('<%=objType.toString().toLowerCase()%>');appCtrl.loadObectForEdit(<%=url %>,null);init();">
	...
	<form method="POST" ng-submit="createUser()" id="frm1">
				...
				<div class="tbl" style="font-size: 12">
					...
					<div class="tblrow">
						...
						<div class="tblcell"><input src="../images/icons/save1.png" type="image"  value="Save" id="Save" alt="Save" title="Save" ng-click="appCtrl.postFormData('../DomainObjectsManager');" />
